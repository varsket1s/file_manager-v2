...
th {font-weight: bold; color: black; background-color: white; padding:.5em 1em .5em .2em;
	text-align: left;cursor:pointer;user-select: none;}
th .indicator {margin-left: 6px }
thead {border-top: 1px solid black; border-bottom: 1px solid #96C4EA;border-left: 1px solid #E7F2FB;
	border-right: 1px solid black; }
#top {height:52px;}
#mkdir {display:inline-block; float: right;padding-top:16px;}
label { display:block; font-size:11px; color: grey;}
#file_drop_target {width:500px; padding:12px 0;font-size:12px;color:#ccc;
...
footer {font-size:11px; color:green; padding:4em 0 0;text-align: left;}
